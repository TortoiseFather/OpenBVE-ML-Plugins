...
namespace OpenBVETrainPluginBackup2
{
        ...
        public bool Load(LoadProperties properties)
{
    ...
    catch (Exception ex)
    {
        ...
        public void Elapse(ElapseData data)
        {
            ...
            currentScore += reward; // Update score
            File.AppendAllText(logFilePath, $"{reward},...");
            TcpClient client = new TcpClient("localhost", 12345);
            NetworkStream stream = client.GetStream();
            byte[] stateBytes = Encoding.ASCII.GetBytes(JsonConvert.SerializeObject(state));
        ...
        private double CalculateReward(ElapseData data)
        {
            ...
            double penalty = data.Vehicle.Speed.KilometersPerHour > data.CurrentSectionLimit ? -1.0 : 0.0;
